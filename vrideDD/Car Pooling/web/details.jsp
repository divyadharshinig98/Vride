...
<h1>Welcome to <span class="blue-text">Car Pooling<a href="home.jsp" style="float:right"><strong>LogOut<strong></a>
</span></h1><img src="images/welcome-brd.jpg" alt="">
<div style="padding: 10px 0px; width: 596px; float: left;"><br>
<form name="form" method="post" action="info.jsp">
<center>
<table>
<tr><td>EmployeeID:</td><td><input type="text" name="eid">
<tr><td>Employee Name:</td><td><input type="text" name="ename">
<tr><td>Department:</td><td><input type="text" name="dpt">
<tr><td>E-mail:</td><td><input type="text" name="email"></td></tr>
<tr><td>ContactNumber:</td><td><input type="text" name="contact"></td></tr>
<tr><td>Address1:</td><td><input type="text" name="add1"></td></tr>
<tr><td>Route: &nbsp&nbsp From:</td><td><input type="text" name="routefrom"></td><td>To:<input type="text" name="routeto"></td></tr>
<tr><td>Timings:</td><td><input type="text" name="timings"></td></tr>
<tr><td>Driving:</td><td><input type="text" name="driver"></td></tr>
<tr><td>Persons</td><td><input type="text" name="person"></td></tr>
